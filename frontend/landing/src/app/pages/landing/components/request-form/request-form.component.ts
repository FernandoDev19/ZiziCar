...
import { VehicleFormComponent } from "./layout/vehicle-form/vehicle-form.component";
...
@Component({
  ...
  imports: [VehicleFormComponent, ContactFormComponent, NgOptimizedImage, NgClass, CurrencyPipe],
  standalone: true,
