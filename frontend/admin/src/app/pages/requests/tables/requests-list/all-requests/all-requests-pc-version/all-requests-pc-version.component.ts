...
@Component({
  selector: 'all-requests-app-pc-version',
  standalone: true,
  imports: [CommonModule, TableModule, FontAwesomeModule],
  templateUrl: './all-requests-pc-version.component.html',
  styleUrl: './all-requests-pc-version.component.css'
})
export class AllRequestsPcVersionComponent {
  @Input() requests!: DataTableForRequestAdminInterface[] | DataTableForRequestProviderInterface[];
