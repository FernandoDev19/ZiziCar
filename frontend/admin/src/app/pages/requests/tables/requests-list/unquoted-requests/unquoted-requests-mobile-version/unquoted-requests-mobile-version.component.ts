...
@Component({
  selector: 'app-unquoted-requests-mobile-version',
  standalone: true,
  imports: [CommonModule, FontAwesomeModule],
  templateUrl: './unquoted-requests-mobile-version.component.html',
  styleUrl: './unquoted-requests-mobile-version.component.css'
})
export class UnquotedRequestsMobileVersionComponent {
