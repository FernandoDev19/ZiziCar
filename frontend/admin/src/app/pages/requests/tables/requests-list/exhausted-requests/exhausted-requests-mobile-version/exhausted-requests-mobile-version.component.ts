...
@Component({
  selector: 'app-exhausted-requests-mobile-version',
  standalone: true,
  imports: [CommonModule, FontAwesomeModule],
  templateUrl: './exhausted-requests-mobile-version.component.html',
  styleUrl: './exhausted-requests-mobile-version.component.css'
})
export class ExhaustedRequestsMobileVersionComponent {
