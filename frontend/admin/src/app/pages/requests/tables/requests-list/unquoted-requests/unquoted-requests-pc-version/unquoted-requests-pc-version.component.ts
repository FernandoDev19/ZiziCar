...
@Component({
  selector: 'app-unquoted-requests-pc-version',
  standalone: true,
  imports: [CommonModule, TableModule, FontAwesomeModule],
  templateUrl: './unquoted-requests-pc-version.component.html',
  styleUrl: './unquoted-requests-pc-version.component.css'
})
export class UnquotedRequestsPcVersionComponent {
