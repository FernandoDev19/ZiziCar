...
@Component({
  selector: 'app-expired-requests-mobile-version',
  standalone: true,
  imports: [CommonModule, FontAwesomeModule],
  templateUrl: './expired-requests-mobile-version.component.html',
  styleUrl: './expired-requests-mobile-version.component.css'
})
export class ExpiredRequestsMobileVersionComponent {
