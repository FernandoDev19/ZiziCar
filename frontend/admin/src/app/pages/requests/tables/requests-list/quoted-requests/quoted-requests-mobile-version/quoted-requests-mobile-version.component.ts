...
@Component({
  selector: 'app-quoted-requests-mobile-version',
  standalone: true,
  imports: [CommonModule, FontAwesomeModule],
  templateUrl: './quoted-requests-mobile-version.component.html',
  styleUrl: './quoted-requests-mobile-version.component.css',
})
export class QuotedRequestsMobileVersionComponent {
  ...
  get paginatedRequestsForProvider() {
    ...
    return (this.requests as DataTableForRequestProviderInterface[]).slice(
      startIndex,
