...
@Component({
  selector: 'app-exhausted-requests-pc-version',
  standalone: true,
  imports: [CommonModule, TableModule, FontAwesomeModule],
  templateUrl: './exhausted-requests-pc-version.component.html',
  styleUrl: './exhausted-requests-pc-version.component.css'
})
export class ExhaustedRequestsPcVersionComponent {
